            ...
            <x-admin.filter-menu dropdownId="usersFilterMenu" buttonText="Filtrele">
                <div class="row gap-5">
                    <div class="col-xl-12">
                        ...
                        <div>
                            <x-admin.form-elements.team-select dropdownParent="#usersFilterMenu"
                                ...
                                customAttr="data-table-filter=team_id"
                                :allowClear="true" />
                        </div>
                    </div>
                    <div class="col-xl-12">
                        ...
                        <div>
                            <x-admin.form-elements.gender-select dropdownParent="#usersFilterMenu"
                                ...
                                customClass="form-select-sm"
                                customAttr="data-table-filter=gender_id"
                    ...
                    <div class="col-xl-12 mt-3">
                        <div>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="frozenAccountsFilterSwitch" data-table-filter="is_frozen">
                    ...
                    <div class="col-xl-12">
                        <div>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="privateAccountsFilterSwitch" data-table-filter="is_private">
