<div class="card card-flush h-md-50 mb-5 mb-xl-10" wire:init="loadData">
    ...
    <div class="card-body d-flex flex-column justify-content-between {{ $isLoading ? 'loading' : '' }}">
        <div>
            ...
            <!--end::Info-->
            <!--begin::Subtitle-->
            <span class="text-gray-500 pt-1 fw-semibold fs-6">Bugün Yüklenen Video Sayısı</span>
            <!--end::Subtitle-->
        </div>
        ...
        <div class="mt-5">
            ...
            <!--end::Info-->
            <!--begin::Subtitle-->
            <span class="text-gray-500 pt-1 fw-semibold fs-6">Bugün Yüklenen Video Süresi</span>
            <!--end::Subtitle-->
        </div>
