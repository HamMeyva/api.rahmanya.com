...
class CommentDislikedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    protected string $notification_type = Variable::NOTIFICATION_TYPE_COMMENT_DISLIKED;
    ...
    public function __construct(protected VideoCommentReaction $videoCommentReaction)
    {
        ...
        $this->body = "{$likerNickName} yorumunu beğenmedi: " . Str::limit($this->comment->content, 50);
        $this->data = [
        ...
        $this->channelUserId = $video->user_id;
    }
