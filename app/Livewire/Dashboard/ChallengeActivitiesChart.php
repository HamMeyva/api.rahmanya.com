...
class ChallengeActivitiesChart extends Component
{
    public $isLoading = true, $categories = [], $data = [];

    public function loadData(): void
    {
        $result = $this->getChallengeActivitiesData();

        $this->categories = $result['categories'];
        $this->data = $result['data'];

        $this->dispatch('challengeActivitiesDataLoaded', ['categories' => $result['categories'], 'data' => $result['data']]);
    ...
    {
        return view('livewire.dashboard.challenge-activities-chart');
    }

    public function getChallengeActivitiesData(): array
    {
        Carbon::setLocale('tr');
        $now = Carbon::today();
        ...
        $resultsThisWeek = Challenge::raw(function ($collection) use ($pipelineThisWeek) {
        ...
        $resultsLastMonth = Challenge::raw(function ($collection) use ($pipelineLastMonth) {
