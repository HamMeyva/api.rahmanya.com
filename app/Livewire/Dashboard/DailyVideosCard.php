...
class DailyVideosCard extends Component
{
    ...
    {
        return view('livewire.dashboard.daily-videos-card');
    }
    ...
    public function getDailyVideosData()
    {
        ...
        $result = Video::raw(function ($collection) use ($todayUtc) {
        ...
        $featuredUsersResult = Video::raw(function ($collection) use ($todayUtc) {
            return $collection->aggregate([
                [
                    '$match' => [
                        'created_at' => ['$gte' => $todayUtc]
