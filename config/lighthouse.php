...
use App\Http\Middleware\CheckIfMaintenanceMode;
return [
    /*
    |--------------------------------------------------------------------------
    | Route Configuration
    ...
    */
    ...
    'subscriptions' => [
        'enable' => env('LIGHTHOUSE_SUBSCRIPTIONS_ENABLE', true),
        /*
         ...
         */
        'storage' => \Nuwave\Lighthouse\Subscriptions\Storage\CacheStorageManager::class,
